...
.rk-n{width:28px;text-align:center;font-size:11px;color:var(--t4);flex-shrink:0;letter-spacing:1px;font-weight:600}
.rk-n.gld{font-size:17px}
.rk-inf{flex:1;min-width:0}
.rk-t{display:block;font-weight:600;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.rk-a{display:block;font-size:11px;color:var(--t3)}
